          ...
          children: <Widget>[
            new Padding(
              ...
              child: new RaisedButton(
                  child: new Text('点击带参数返回'), onPressed: _onPressed),
            ),
            new Padding(
              padding:
                  const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
            ...
            new Padding(
              padding:
                  const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
              child: new RaisedButton(
                  child: new Text('销毁除了栈顶的所有页面'), onPressed: _onPressed3),
            ),
            new Padding(
              padding:
                  const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
              child: new RaisedButton(
                  child: new Text('跳转并销毁当前页面（1）'), onPressed: _onPressed4),
            ),
            new Padding(
              padding:
                  const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
              child: new RaisedButton(
                  child: new Text('跳转并销毁当前页面（2）'), onPressed: _onPressed5),
            ),
          ],
        ),
      ),
